...
<template>
      ...
      <transition name="slide">
        <div v-if="show" class="sidebar flex-col min-h-screen select-none" @click.self="closeSidebar">
          ...
          <div class=" inline-flex">
            <p class="text-4xl pl-4 pb-9 font-semibold ">Your Cart</p> <button class="mb-6 ml-72 "  @click="closeSidebar" >
              <X />
            </button>
          </div>
  ...
  <!--Footer-->
  <div
    class="b-20 relative mx-10 mt-20 max-w-[1950px] select-none items-center border-t-[1px] border-black bg-[#f7f7f7] pb-5 pt-12">
  ...
  <div class="mx-10 mb-5 max-w-[1950px] select-none items-center border-t-[1px] border-gray-300 bg-white pt-8">
